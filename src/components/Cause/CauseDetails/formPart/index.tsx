        ...
        <form className="">
          ...
          <div className="">
            ...
            <div className="flex items-center md:flex-nowrap flex-wrap mb-4 md:gap-0 gap-2">
              <label
                htmlFor="amount"
                className="md:rounded-none md:rounded-s-lg rounded-lg  bg-white whitespace-nowrap dark:bg-darkmode dark:border-dark_border border border-border px-4 py-5 text-base "
              >
                Donation total:
              </label>
              <input
                ...
                name="amount"
                id="amount"
                placeholder="$2,001,230.00"
                className="px-4 py-5 text-base border md:rounded-none md:rounded-e-lg rounded-lg dark:focus:border-primary focus:border-primary dark:bg-darkmode focus-visible:outline-hidden dark:border-dark_border placeholder:text-primary/30"
              />
            </div>
            <button
              onClick={(e) => {
